...
> **Note:** This module builds upon the [9 standard query types](../basic_queries/) and provides more complex reasoning patterns.

## Overview

While the base system in `basic_queries/` supports 9 query types (entity search, statistics, similarity, paths, etc.), these **advanced queries** require:
